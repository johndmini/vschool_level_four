...
export default function App() {
    ...
    return(
        <Box sx={{ width: '50%', margin: '0 auto', marginTop: '80px', border: '5px solid grey', textAlign: 'center', padding: '10px' }}>
            <Typography variant="h5">CSS Color Gradient Tool Generator</Typography>
            <FormControl>
                <TextareaAutosize 
                    style={{ width: 515, height: 300, background: `linear-gradient(${angle}deg, ${colorStateOne}, ${colorStateTwo} ${hardLine}%)` }}/>
                <br />
                <TextareaAutosize 
                    readOnly 
                ...
                <ButtonGroup style={{ marginTop: '20px'}}>
                    <Button
                        ...
                        name="color1" 
                        variant="contained" 
                        sx={{ display: "inline-block", height: 50, width: 200, backgroundColor: colorStateOne, padding: 0, marginRight: '120px' }}
                    ...
                    <Button 
                        ...
                        name="color2"
                        variant="contained" 
                        sx={{ display: "inline-block", height: 50, width: 200, backgroundColor: colorStateTwo, padding: 0 }}
