...
export default function MapUgly() {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://api.vschool.io/johndaviddelgado/thing/${id}`)
      .then((res) => getData())
  ...
  const handleEditUgly = (id) => {
    ...
    axios
      .put(`https://api.vschool.io/johndaviddelgado/thing/${id}`, editUgly)
      .then((res) => getData());
  ...
  const getData = () => {
    axios
      .get('https://api.vschool.io/johndaviddelgado/thing')
